...
def axis_units(
    ax: Axes,
    *,
    x_format_wrapper: Optional[Callable[Callable, Callable]] = None,
    y_format_wrapper: Optional[Callable[Callable, Callable]] = None,
    format_wrapper: Callable[Callable, Callable] = lambda x: x,
):
